...
VALUES (1, 'Opening Keynote: Meta-modern Software Architecture',
        ...
        '2022-04-13 10:00:00.000', '["Neal Ford "]' format json),
       ...
       (3, 'Forward with Java 18 and Beyond!',
        ...
        '2022-04-13 10:00:00.000', '["Billy Korando "]' format json),
       (4, 'Refactoring Code: An Incremental and Purpose Driven Approach',
        ...
        '2022-04-13 10:00:00.000', '["Venkat Subramaniam "]' format json),
       (5, 'Apache Kafka simply explained', 'Learn Apache Kafka in uncomplicated and entertaining terms and get equipped with practical knowledge for your first steps in the Apache Kafka world.',
        '2022-04-13 10:00:00.000', '["Olena Kutsenko "]' format json),
       (6, 'Why having your own Mr. Miyagi shouldn\’t be luck but a given.',
        ...
        '2022-04-13 10:00:00.000', '["Kelly Jille "]' format json),
       (7, 'Double-plus Ungood: Why Log4Shell Is So Bad', 'Log4Shell shook the Java community. What made it so bad and what do we do about it?', '2022-04-13 10:00:00.000', '["Josh Cummings "]' format json),
       (8, 'Alpine.js : Declare and React with Simplitcy',
        ...
        '2022-04-13 10:00:00.000', '["Luis Majano "]' format json),
       (9, 'CI/CD Pipelines : What, Why, How?',
        ...
        '2022-04-13 10:00:00.000', '["Ixchel Ruiz "]' format json),
       (10, 'A Tour of the Modern Java Platform',
        ...
        '2022-04-13 10:00:00.000', '["James Ward "]' format json),
       (11, 'Java on Kubernetes: What I wish I knew first',
        ...
        '["Abel Salgado", "Alberto C. Ríos "]' format json),
       (12, 'Zero Trust Architecture',
        ...
        '2022-04-13 10:00:00.000', '["Sendil Kumar "]' format json),
       (13, 'Batch Processing in Action',
        ...
        '2022-04-13 10:00:00.000', '["Hillmer Chona", "Rodrigo Graciano "]' format json),
       (14, 'Liberation for your data!',
        ...
        '2022-04-13 10:00:00.000', '["Hugo Guerrero "]' format json),
       (15, 'What is Adoptium?',
        ...
        '2022-04-13 10:00:00.000', '["George Adams "]' format json),
       (16, 'Writing Code for the Future',
        ...
        '2022-04-13 10:00:00.000', '["Valarie Regas "]' format json),
       (17, 'Exploring Stateful Microservices in the Cloud Native World',
        ...
        '2022-04-13 10:00:00.000', '["Grace Jansen "]' format json),
       (18, 'Measuring the Impact of Software Craft',
        ...
        '2022-04-13 10:00:00.000', '["Ben Scott "]' format json),
       (19, 'Stranger Danger: Your Java Attack Surface Just Got Bigger',
        ...
        '2022-04-13 10:00:00.000', '["Brian Vermeer "]' format json),
       (20, 'On the Edge of My Server',
        ...
        '2022-04-13 10:00:00.000', '["Brian Rinaldi "]' format json),
       (21, 'Making Maven Marvelous',
        ...
        '2022-04-13 10:00:00.000', '["Giovanni van der Schelde "]' format json),
       ...
       (23, 'Container Usage Patterns',
        ...
        '2022-04-13 10:00:00.000', '["Raju Gandhi "]' format json),
       (24, 'How does a matching engine work?',
        ...
        '2022-04-13 10:00:00.000', '["Juan D Bustamante "]' format json),
       (25, 'What\’s New in Spring in 2022',
        ...
        '2022-04-13 10:00:00.000', '["Spencer Gibb "]' format json),
       (26, 'Quarkus. A Bliss for developers',
        ...
        '2022-04-13 10:00:00.000', '["Alex Soto "]' format json),
       ...
       (28, 'Removing complexity from integration tests using Testcontainers!',
        ...
        '2022-04-13 10:00:00.000', '["Oleg Šelajev "]' format json),
       (29, 'The Future is Kube-Native',
        ...
        '2022-04-14 10:00:00.000', '["Edson Yanaga "]' format json),
       (30, 'Getting Caught up with Kotlin',
        ...
        '2022-04-14 10:00:00.000', '["Justin Lee "]' format json),
       (31, 'Bootiful Edge Services',
        ...
        '2022-04-14 10:00:00.000', '["Josh Long "]' format json),
       (32, 'Typescript for the busy Java developer',
        ...
        '2022-04-14 10:00:00.000', '["Orlando Valdez "]' format json),
       (33, 'DevOps for Java Shops',
        ...
        '2022-04-14 10:00:00.000', '["Brian Benz "]' format json);
